...
config.addon = {
  ...
  set excludelist (val) {app.storage.write("whitelist", val)},
  set includelist (val) {app.storage.write("includelist", val)},
  get state () {return app.storage.read("state") !== undefined  ? app.storage.read("state") : "OFF"},
  get excludelist () {return app.storage.read("whitelist") !== undefined ? app.storage.read("whitelist") : []},
  get includelist () {return app.storage.read("includelist") !== undefined ? app.storage.read("includelist") : []},
  /*  */
  "page": {
